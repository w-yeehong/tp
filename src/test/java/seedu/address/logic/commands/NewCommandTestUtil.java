...
public class NewCommandTestUtil {
    ...
    public static final String VALID_ROOM_NUMBER_SEVEN_DESC = " " + PREFIX_ROOM_NUMBER + "7";
    public static final String VALID_ROOM_NUMBER_EIGHT_DESC = " " + PREFIX_ROOM_NUMBER + "8";
