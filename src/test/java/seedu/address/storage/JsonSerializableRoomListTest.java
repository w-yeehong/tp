...
class JsonSerializableRoomListTest {
    ...
    private static final Path WRONG_ROOM_LIST = TEST_DATA_FOLDER.resolve("notJsonFormatCovigentApp.json");
    @Test
    ...
    @Test
    public void toModelType_typicalRoomFile_failure() throws Exception {
        JsonSerializableRoomList dataFromFile = JsonUtil.readJsonFile(WRONG_ROOM_LIST,
                JsonSerializableRoomList.class).get();
